...
def invoice_header_query(api_key, app_id, card_type, card_no, card_encrypt, start_date, end_date):
	invoice_list = []
...
def get_einvoice(api_key, app_id, card_type, card_no, card_encrypt, start_date, end_date):
	invoice_list = invoice_header_query(api_key, app_id, card_type, card_no, card_encrypt,start_date, end_date)
...
if __name__ == '__main__':
	...
	card_type = "3J0002"
	#card_no = "/SMV1EFQ"
	#card_encrypt = "stanford++98"

	card_no = "/+8R242Q"
	card_encrypt = "86d3"
	invoice_list = get_einvoice(api_key, app_id, card_type, card_no, card_encrypt, "2015/10/01", "2015/10/20")
	#invoice_list = get_einvoice(api_key, app_id, card_type, card_no, card_encrypt)
